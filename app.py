...
st.title("AI Blog Generatrator Agent...🤖")
st.header("Create High-Quality Blog Content using Agentic AI")
...
if submit_title: # Handle button click for submitting information
    ...
    st.write(title_chain.invoke({'title': title_of_the_blog, 'keywords': formatted_keywords, 'blog_length':num_of_words})) 
    # Generate and display the blog content using the title chain
